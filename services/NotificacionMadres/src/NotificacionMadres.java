...
@ExposeToClient
public class NotificacionMadres extends JavaServiceSuperClass {
   public String sendEmailNotification(String correomadre, String tramite, String std, String fechahora, String comentario){ 
      try{        
