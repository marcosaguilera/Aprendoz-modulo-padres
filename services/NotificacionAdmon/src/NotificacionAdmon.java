...
@ExposeToClient
public class NotificacionAdmon extends JavaServiceSuperClass {
    public String sendEmailNotification(String tramite, String std, String fechahora, String comentario){ 
      try{        
            ...
            message.setFrom(new InternetAddress("eventualidades@rochester.edu.co"));       
               ...
               message.addRecipient(
                  Message.RecipientType.TO, new InternetAddress("seguridad@rochester.edu.co"));
               message.addRecipient(
             ...
             message.setText(
              ...
              "</ul>"+"<br/>"+
              "Para visualizar o realizar la aprobación de este tramite por favor dirijase al Módulo de Docentes en la pestaña Tramites.<br/>"+
              "Link de acceso: http://docentes.rochester.edu.co:8080/Administracion/login.html<br/><br/>"+
