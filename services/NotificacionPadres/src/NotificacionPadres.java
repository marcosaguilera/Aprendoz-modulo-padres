...
@ExposeToClient
public class NotificacionPadres extends JavaServiceSuperClass {
    public String sendEmailNotification(String correopadre, String tramite, String std, String fechahora, String comentario){ 
      try{        
